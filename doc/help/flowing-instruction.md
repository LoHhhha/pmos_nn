...
- 按住鼠标左键并拖动左侧节点栏中的节点模板，松开后可将节点添加到画布指定位置中。<br>Hold down the left mouse button and drag the node template in the left operator bar. Release the button and create node to the specified position in the canvas.
